    ...
    for m=1:size(Geo_Flux,1)
        for n=1:size(Geo_Flux,2)
            ...
            if b(m,n)==0
                ...
                %     else
                %     end
                if ismember(t,[31557600*output_t:31557600*output_t:tf])==1
                    melt_hold(m,n,t/(31557600*output_t))=melt_tot(m,n);
                    h_hold(m,n,t/(31557600*output_t))=H(m,n);
                else
                end
